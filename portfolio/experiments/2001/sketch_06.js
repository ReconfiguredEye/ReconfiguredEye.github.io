function setup() {
  ...
  function drawFloorAndCeiling() {
    ...
    let rows = 25; // Number of rows for floor and ceiling
    let blockWidth = 20;
    let blockHeight = 40;
    let gap = 5;
    let floorY = 160; // Adjust vertical position of the floor
    let ceilingY = -270; // Adjust vertical position of the ceiling
